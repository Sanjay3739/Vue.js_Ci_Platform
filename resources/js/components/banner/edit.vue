                    ...
                    <form @submit.prevent="submitForm">
                        <div class="form-row mb-4">
                            <div class="col-lg-12 ">
                                ...
                                <textarea rows="5" type="text" v-model="banner.text" name="text" id="editor1"
                            ...
                            <div class="col-lg-12  mt-3">
                                <div class="row">
                                    <div class="col-lg-3 col-md-12 ">
                                        ...
                                        <input type="number" name="sort_order" v-model="banner.sort_order"
                                            class="form-control ">
                                    </div>
                                    <div class="col-lg-3 col-md-12 ">
    ...
    export default {
        ...
        methods: {
            ...
            submitForm() {
                ...
                axios.put(`/api/banner/${this.$route.params.banner_id}`, formData)
