            ...
            <div class="col-md-12" id="card">
                ...
                <div class="j">
                    <div class="d-flex justify-content-between m-3">
                        ...
                        <div class="car ">
                            <a href="#">
                                <router-link to="/banner/create" type="button"
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="banner in banners" :key="banner.banner_id">
                                            ...
                                            <td
                                                ...
                                                <router-link :to="`/banner/${banner.banner_id}/edit`" class=""><img
                                                        src="Images/edit.png" style="height: 22px; width: 22px;">

                                                </router-link>
                                                <a @click="deletebanner(banner.banner_id)" id="delete">
    ...
    methods: {
        async deletebanner(id) {
            try {
                ...
                this.banners = this.banners.filter(page => page.banner_id !== id);
            } catch (error) {
                console.error(error);
            }
        },
