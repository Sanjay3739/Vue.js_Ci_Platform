    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 mw-100" id="card">
                        ...
                        <form class="m-0" enctype="multipart/form-data">
                            ...
                            <div class="rb">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="rat" placeholder="search" class="form-control rbc">
                                </div>
                            </div>
                        </form>
                        <div>
                            <a href="#">
                                <router-link to="/missionskill/create" type="button"
                    ...
                    <div class="table-responsive">
                        <table
                            class="table table-hover mw-100 w-100 table-bordered text-center ">
                            ...
                            <tbody>
                                <tr v-for="missionskill in missionskills" :key="missionskill.skill_id">
                                    ...
                                    <td
                                        ...
                                        <router-link :to="`/missionskill/${missionskill.skill_id}/edit`" class=""><img
                                                src="Images/edit.png" style="height: 22px; width: 22px;">

                                        </router-link>
                                        <a @click="deleteskill(missionskill.skill_id)" id="delete">
...
export default {
    ...
    methods: {
        async deleteskill(id) {
            try {
                await axios.delete(`/api/missionskill/${id}`);
                this.missionskills = this.missionskills.filter(missionskill =>missionskill.skill_id !==id);
